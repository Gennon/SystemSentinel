...
## Acceptance Criteria
- [x] A weekly summary is sent via chat on a configurable day and time (default: Monday 08:00)
- [x] The weekly report includes:
...
- [x] Trends are expressed as deltas with direction (e.g. "+4.2 GB disk used, +12% vs last week")
- [x] The weekly report is sent as a multi-section chat message
